...
def render_patient_data_context(
    ...
    lines.append("- Variants not mentioned in source are NOT covered. Obtain raw WGS (e.g., Dante Labs / Nebula) to expand coverage.")
    ...
    lines.append("- DB enrichment is best-effort: OMIM requires a key; ClinVar / SNPedia / ClinPGx are keyless.")
    lines.append("")
...
---
## TL;DR
- MTHFR C677T rs1801133 C/T (heterozygous, synthetic example)
- APOE rs429358 C/T; rs7412 C/C → ε?/ε3 (synthetic example)
- FADS1 rs174547 C/T (synthetic example)
""")
